...
\font\subhead="Lucida Sans" at 13pt
\font\subsubhead="Lucida Sans" at 11pt
...
\newcommand\cvitem[2][\relax]{%
    \par\vspace{.8em}
    \if\relax#1\else{\textit{#1}}\hspace{1em}\fi%
    {\textbf{#2}}%
    \par\vspace{.4em}
}
\newcommand\showdoi[1]{%
...
{\LARGE Luis Pedro Coelho}
\medskip

{\small Carnegie Mellon University\\
5000 Forbes Ave, GHC 7405\\
Pittsburgh, PA (USA)\\
\textit{phone}: (+1)-412-330-8306\\
\textit{email}: lpc@cmu.edu}
...
Developing new methods for learning from both a very large collection of images
of fluorescently tagged proteins and other forms of data (sequence information,
database information). This work builds on my past work and is, at the moment,
still unpublished.
...
SLIF is a search engine that indexes biomedical papers with their images. This
project was a finalist in the Elsevier Grand Challenge (4 teams out of 70 were
chosen for the final). I represented our team in both the final and the
semi-final of this competition.

\cvitem[2005-2006]{Approximate String Indexing}
Working with Arlindo Oliveira, in INESC/ID (Lisbon).
...
Designed and taught a semester-long course on computer programming for
...
Co-developed and co-taught an introductory course in computer usage in Cac\'em,
an underprivileged neighbourhood near Lisbon (pro-bono work).
...
Headed the local organising committee for this the 2010 edition of this
...
Started the Beira Project (with Rita Reis). The Beira Project has held
organised successful fund-raising activities for partner organisations in
Mozambique.

\cvitem[2002-2004]{Producer for IST Theatre Group}
Producer for the IST Theatre Group. Activities included fund-raising and
management.
...
Several contribution in the areas of \textbf{machine learning} and
\textbf{computer vision}. Previously a \textsc{kde} developer. The \textsc{kde}
project is one of the largest open-source projects in the world with several
hundred developers and over one million lines of code.

\section{Skills}

\cvitem{Computer Programming}
Wide experience in \textbf{C}, \textbf{C\raisebox{.1em}{\tiny \bf ++}},
\textbf{Python}, \textbf{Matlab}, and \textbf{Haskell}.

\cvitem{Cell Culture \& Imaging}

\cvitem{Language Skills}
Bilingual in \textbf{English} and \textbf{Portuguese}, fluent \textbf{German}
and \textbf{French}.
