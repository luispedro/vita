...
\cvitem[2022--2023]{Highly Cited Researcher (\emph{Cross-field} category)}
...
\textbf{Total number of citations}: 16,097 (Google Scholar); 10,315 (Web of Science)
\\
\textbf{h-index}: 43 (Google Scholar); 37 (Web of Science)
...
\item Yiqian Duan, Celio Dias Santos-Junior, Thomas Sebastian Schmidt, Anthony Fullam, Breno L. S. de Almeida, Chengkai Zhu, Kuhn Michael, Xing-Ming Zhao⁺, Peer Bork, \textbf{Luis Pedro Coelho}⁺, \emph{A catalogue of small proteins from the global microbiome}, in \pubname{bioRxiv}, 2023 \showdoi{10.1101/2023.12.27.573469}

\item Célio Dias Santos-Júnior\costar, Marcelo Der Torossian Torres\costar, Yiqian Duan, Álvaro Rodríguez del Río, Thomas S.B. Schmidt, Hui Chong, Anthony Fullam, Kuhn Michael, Chengkai Zhu, Amy Houseman, Jelena Somborski, Anna Vines, Xing-Ming Zhao, Peer Bork, Jaime Huerta-Cepas, Cesar de la Fuente-Nunez\cosenior, \textbf{Luis Pedro Coelho}\cosenior \emph{Computational exploration of the global microbiome for antibiotic discovery} in \pubname{bioRxiv} 2023 \showdoi{10.1101/2023.08.31.555663}
