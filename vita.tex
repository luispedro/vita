...
\textbf{Total number of citations}: 15,971 (Google Scholar); 10,221 (Web of Science)
\\
\textbf{h-index}: 43 (Google Scholar); 35 (Web of Science)
...
\item Marija Dmitrijeva, Janko Tackmann, João Matias Rodrigues, Jaime Huerta-Cepas, \textbf{Luis Pedro Coelho}⁺, Christian von Mering⁺ \emph{A global survey of eco-evolutionary pressures acting on horizontal gene transfer} in \pubname{Research Square} 2023 \showdoi{10.21203/rs.3.rs-3062985/v1}
