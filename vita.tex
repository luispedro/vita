...
\textbf{Total number of citations}: 20,180 (Google Scholar); 12,434 (Web of Science)
\\
\textbf{h-index}: 48 (Google Scholar); 41 (Web of Science)
...
\item Svetlana Ugarcina Perovic\costar, Vedanth Ramji\costar, Hui Chong, Yiqian Duan, \textbf{Luis Pedro Coelho}, \emph{argNorm: Normalization of antibiotic resistance gene annotations to the Antibiotic Resistance Ontology (ARO)}, in \pubname{QUT eprints}, 2024 \showdoi{10.5204/rep.eprints.252448}
