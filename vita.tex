...
\textbf{Total number of citations}: 22,489 (Google Scholar); 13,841 (Web of Science)
\\
\textbf{h-index}: 50 (Google Scholar); 42 (Web of Science)
...
\item Senying Lai, Shaojun Pan, \textbf{Luis Pedro Coelho}\cosenior, Wei-Hua Chen\cosenior,
Xing-Ming Zhao\cosenior, \emph{metaMIC: reference-free Misassembly Identification and
Correction of de novo metagenomic assemblies} in \pubname{Genome Biology} 2022
\showdoi{10.1186/s13059-022-02810-y}


\item Shaojun Pan, Chengkai Zhu, Xing-Ming Zhao\cosenior, and \textbf{Luis Pedro
Coelho}\cosenior \emph{A deep siamese neural network improves metagenome-assembled
