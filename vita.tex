...
\textbf{Total number of citations}: 13,133 (Google Scholar); 8,336 (Web of Science)
\\
\textbf{h-index}: 39 (Google Scholar); 30 (Web of Science)
...
Bilingual in \textbf{English} and \textbf{Portuguese}; fluent in
...
\begin{enumerate}
\item Shaojun Pan, Xing-Ming Zhao⁺, \textbf{Luis Pedro Coelho}⁺, \emph{SemiBin2: self-supervised contrastive learning leads to better MAGs for short- and long-read sequencing} in \pubname{bioRxiv} 2023 \showdoi{10.1101/2023.01.09.523201}
