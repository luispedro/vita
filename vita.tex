...
annotation and profiling framework} \pubname{Bioinformatics}, 2016 (Advanced
Access) \showdoi{10.1093/bioinformatics/btw183}.
\contribution{I participated in the design of the tool and wrote part of the implementation.}
...
\contribution{I supervised the first-author, then a PhD student, in the
...
\contribution{I supervised D.P-N., at the time, a bioinformatics MSc student,
in the statistical analysis of the RNA-seq data.}
...
\contribution{I designed and implemented the algorithm, collected microscopy
...
\contribution{I wrote the underlying computer vision software and the manuscript.}
...
\contribution{With the papers below, this forms a package on the SLIF project,
...
and helped draft the two below.}
...
\emph{Structured Literature Image Finder}, \pubname{Proceedings of BioLINK}
