...
\cvitem[2017]{S. Colin${}^{*}$, \textbf{L. P. Coelho}${}^{*}$, et al.,
    \emph{Quantitative 3D-Imaging of Environmental Microbial Eukaryotes using
    Automated Fluorescence Microscopy} in \pubname{eLife} (2017)
...
\href{https://twitter.com/luispedrocoelho}{@luispedrocoelho} (>1,600 followers).
