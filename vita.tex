...
\cvitem[2021]{\HighlightFont \textbf{L. P. Coelho} et al. \emph{Towards the biogeography of
prokaryotic genes} in \pubname{Nature} \showdoi{10.1038/s41586-021-04233-4}}
\cvitem[2021]{\HighlightFont S. Pan, \ldots, \textbf{L. P. Coelho} \emph{SemiBin:
Incorporating information from reference genomes with semi-supervised deep
learning leads to better metagenomic assembled genomes (MAGs)} in
\pubname{BioRxiv} \showdoi{10.1101/2021.08.16.456517} (currently being revised for
resubmission to \pubname{Nature Communications})}
\cvitem[2019]{\HighlightFont \textbf{L. P. Coelho} et al., \emph{NG-meta-profiler: fast
processing of metagenomes using NGLess, a domain-specific language} in
\pubname{Microbiome} \showdoi{10.1186/s40168-019-0684-8}}
...
\textbf{Total number of citations}: 8,736 (Google Scholar); 5,201 (Web of Science)
\\
\textbf{h-index}: 32 (Google Scholar); 27 (Web of Science)

\begin{center}
    \includegraphics[height=28ex]{2021-11-30_citations.pdf}
\end{center}
...
\emph{Towards the biogeography of prokaryotic genes} at \pubname{Nature} 2022
...
\begin{enumerate}
\item \emph{Micropeptides: Biogenesis and Function/GPCRs}, Micropeptides:
    Biogenesis and Function/GPCRs Keystone Symposium, April 2022 (forthcoming)
