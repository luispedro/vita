...
Germany}\\
\textcolor{darkg}{phone} :  +49 (0) 6221 387-0\\
...
A Bayesian network is a fundamental class of probabilistic graphical models. In
my work, I investigated the theoretical limits of learning from noisy data.
...
Berget, Jonathan W.  Jarvik, and Robert F. Murphy, \emph{Local Features for
Determining Subcellular Location with Better Generalization}
...
computer vision, Journal of Open Research Computation (forthcoming)
\preprint{http://arxiv.org/abs/1211.4907v1}
