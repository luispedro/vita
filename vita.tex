...
\textbf{Total number of citations}: 11,613 (Google Scholar); 7,422 (Web of Science)
\\
\textbf{h-index}: 36 (Google Scholar); 29 (Web of Science)
...
\item Rémi Gschwind, Svetlana Ugarcina Perovic, Marie Petitjean, Julie Lao, \textbf{Luis Pedro Coelho}, Etienne Ruppé \emph{ResFinderFG v2.0: a database of antibiotic resistance genes obtained by functional metagenomics} in \pubname{BioRxiv} 2022 \showdoi{10.1101/2022.10.19.512667}
