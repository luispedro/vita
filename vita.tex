...
\textbf{Total number of citations}: 10,574 (Google Scholar); 6,747 (Web of Science)
\\
\textbf{h-index}: 35 (Google Scholar); 28 (Web of Science)

\begin{center}
    \includegraphics[height=28ex]{citations-h-index.pdf}
\end{center}
...
\item Álvaro Rodríguez del Río, Joaquín Giner-Lamia, Carlos P. Cantalapiedra,
Jorge Botas, Ziqi Deng, Ana Hernández-Plaza, Lucas Paoli, Thomas S.B. Schmidt,
Shinichi Sunagawa, Peer Bork,  \textbf{Luis Pedro Coelho}, Jaime Huerta-Cepas
\emph{Functional and evolutionary significance of unknown genes from
uncultivated taxa } in \pubname{BioRxiv} 2022
\showdoi{10.1101/2022.01.26.477801}
...
\item Hui Chong, Qingyang Yu, Yuguo Zha, Guangzhou Xiong, Nan Wang, Xinhe
Huang, Shijuan Huang, Chuqing Sun, Sicheng Wu, Wei-Hua Chen, \textbf{Luis
Pedro Coelho}, Kang Ning \emph{EXPERT: Transfer Learning-enabled
context-aware microbial source tracking} in \pubname{BioRxiv} 2021
\showdoi{10.1101/2021.01.29.428751}
